...
class LeaderboardEvaluator(object):
    ...
    def _load_and_wait_for_world(self, args, town, ego_vehicles=None):
        ...
        print("Loaded town is: ", CarlaDataProvider.get_map().name)
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            #RAI index instance
            self.rain_engine = self.agent_instance.rai_engine
    ...
    def run(self, args):
        ...
        while route_indexer.peek():
            ...
            while iterations > -1:
                ...
                self.rain_engine.register_model_rai(agent_score)
            break
            # run
            # self._load_and_run_scenario(args, config)
...
def main():
    ...
    parser.add_argument('--timeout', default="500.0",
